...
```
m6xx-qr-code-scanner/
├── main.py                     # Main application
├── field_names_en.json         # Field definitions for QR code interpretation (English)
├── field_names_de.json         # Field definitions for QR code interpretation (German)
